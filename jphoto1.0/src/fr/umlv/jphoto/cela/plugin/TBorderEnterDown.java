 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class TBorderEnterDown implements ImageObserver,Transition{
	...
	public void draw(long time, Graphics2D graphics) {
		...
		gBuffer.drawImage(dst,inset2x,startSrcY + inset2y, null);
		gBuffer.drawImage(src,inset1x,startSrcY - dimension.height + inset1y,null);
		gBuffer.dispose();
