 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class TBorderEnterRight implements ImageObserver,Transition{
	...
	public void draw(long time, Graphics2D graphics) {
		...
		gBuffer.drawImage(dst,startSrcX + inset2x,inset2y, null);
		gBuffer.drawImage(src,startSrcX + dimension.width + inset1x,inset1y,null);
		gBuffer.dispose();
